    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    <form action="/pengadaan/update/{id}" class="form" method="POST">
                      @csrf
                    <input type="hidden" id="id" name="id" value="{{ $pengadaan->id }}">
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Total Harga Estimasi" name="total_harga_estimasi" value="{{ $pengadaan->total_harga_estimasi }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label >Total Harga Real</label>
                                        <input type="text" class="form-control" placeholder="Total Harga Real" name="total_harga_real" value="{{ $pengadaan->total_harga_real }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
