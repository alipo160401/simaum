...
<div class="content-header-right col-md-6 col-12">
    <div class="btn-group float-md-right">
        <a href="/ruang/create" class="btn btn-info">Tambah</a>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-md-2">
        <a href="/ruang/exportExcel" target="_blank">
        ...
        <div class="modal-content">
            <form id="deleteForm" method="POST">
                ...
                <div class="modal-header bg-info">
                    <h4 class="modal-title text-white">Apakah anda yakin ingin menghapus Ruang ini ?</h4>
...
<script>
    $(document).on("click", ".tombolHapus", function () {
        var id = $(this).val();
        $("#deleteForm").attr("action", "/ruang/destroy/" + id);
        $("#deleteId").val(id);
        $("#delete").modal();
    });
</script>
