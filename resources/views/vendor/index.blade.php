...
<div class="content-header-right col-md-6 col-12">
    <div class="btn-group float-md-right">
        <a href="/vendor/create" class="btn btn-info">Tambah</a>
    </div>
</div>
@endsection
            ...
            <div class="modal-content">
                <form id="deleteForm" method="POST">
                    ...
                    <div class="modal-header bg-info">
                        <h4 class="modal-title text-white">Apakah anda yakin ingin menghapus Vendor ini ?</h4>
...
$(document).on("click", ".tombolHapus", function(){
        var id = $(this).val();
    $("#deleteForm").attr("action", "/vendor/destroy/"+ id);
    $("#deleteId").val(id);
    $("#delete").modal();
});
</script>
