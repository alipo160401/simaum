...
<div class="content-header-right col-md-6 col-12">
    <div class="btn-group float-md-right">
        <a href="/pemeliharaanRutin/create" class="btn btn-info">Tambah</a>
    </div>
</div>
@endsection
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    <table class="table table-responsive datatable">
                        ...
                        <tbody>
                            @foreach ($pemeliharaanRutin as $data)
                            <tr>
                                <td>{{ $nomor++ }}</td>
        ...
        <div class="modal-content">
            <form id="deleteForm" method="POST">
                ...
                <div class="modal-header bg-info">
                    <h4 class="modal-title text-white">Apakah anda yakin ingin menghapus Pemeliharaan ini ?</h4>
...
<script>
    $(document).on("click", ".tombolHapus", function(){
            var id = $(this).val();
        $("#deleteForm").attr("action", "/pemeliharaanRutin/destroy/"+ id);
        $("#deleteId").val(id);
        $("#delete").modal();
    });
</script>
