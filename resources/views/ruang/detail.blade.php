            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <input type="hidden" id="id" name="id" value="{{ $ruang->id }}">
                        <div class="form-body">
                          <h4 class="form-section">Detail Ruang</h4>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nama Ruang</label>
                                        <input type="text" id="nama" class="form-control" name="nama" value="{{ $ruang->nama }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jenis" value="{{ $ruang->jenis }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
