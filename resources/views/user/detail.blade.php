        ...
        <div class="card">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <div class="form-body">
                        <h4 class="form-section">Detail User</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="role" class="">Role</label>
                                    <input type="text" class="form-control" value="{{$user->role}}" readonly readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nik" class="form-control" name="nik" value="{{ $user->nik }}"
                                        readonly onkeydown="return ( event.ctrlkey || event.altkey
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="no_telp" class="form-control" placeholder="8xxx"
                                            name="no_telp" value="{{ $user->no_telp }}" min="1" required readonly
