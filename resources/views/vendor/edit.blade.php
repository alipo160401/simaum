            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <input type="hidden" id="id" name="id" value="{{ $vendor->id }}">
                        <div class="form-body">
                          <h4 class="form-section">Edit Vendor</h4>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label >Nama Vendor</label>
                                        <input type="text"  class="form-control" placeholder="Nama Vendor" name="nama" value="{{ $vendor->nama }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label >Alamat</label>
                                        <input type="text" id="alamat" class="form-control" placeholder="Alamat" name="alamat" value="{{ $vendor->alamat }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label >Bidang Pekerjaan</label>
                                        <input type="text" class="form-control" placeholder="Bidang Pekerjaan" name="bidang_pekerjaan" value="{{ $vendor->bidang_pekerjaan }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pic_vendor" class="form-control" placeholder="PIC Vendor" name="pic_vendor" value="{{ $vendor->pic_vendor }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label >NPWP</label>
                                        <input type="text" id="npwp" class="form-control" placeholder="NPWP" name="npwp" value="{{ $vendor->npwp }}">
                                    </div>
                                </div>
                            </div>
